<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Ex2.WebForm1" %>
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RangeValidator ID="rvBirthday" runat="server" ControlToValidate="txtBirthday" Display="Dynamic" ErrorMessage="日期应在1900-1-1到2020-1-1之间！" MaximumValue="2020-1-1" MinimumValue="1900-1-1" Type="Date" SetFocusOnError="True"></asp:RangeValidator>
                </td>
            </tr>
            <tr>
